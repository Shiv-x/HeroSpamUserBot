...
async def start_hero():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@LaylaList"))
            await idk(functions.channels.JoinChannelRequest(channel="@AwesomeSupport"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@LaylaList"))
            await ydk(functions.channels.JoinChannelRequest(channel="@AwesomeSupport"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@LaylaList"))
            await wdk(functions.channels.JoinChannelRequest(channel="@AwesomeSupport"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@LaylaList"))
            await hdk(functions.channels.JoinChannelRequest(channel="@AwesomeSupport"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@LaylaList"))
            await sdk(functions.channels.JoinChannelRequest(channel="@AwesomeSupport"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@LaylaList"))
            await adk(functions.channels.JoinChannelRequest(channel="@AwesomeSupport"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@LaylaList"))
            await bdk(functions.channels.JoinChannelRequest(channel="@AwesomeSupport"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@LaylaList"))
            await cdk(functions.channels.JoinChannelRequest(channel="@AwesomeSupport"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@LaylaList"))
            await ddk(functions.channels.JoinChannelRequest(channel="@AwesomeSupport"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@LaylaList"))
            await edk(functions.channels.JoinChannelRequest(channel="@AwesomeSupport"))
